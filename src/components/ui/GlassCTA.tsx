      ...
      <div className="relative bg-white/10 backdrop-blur-md border border-white/20 rounded-full overflow-hidden shadow-lg">
        ...
        <div className="relative z-10 flex items-stretch">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="flex-1 bg-azure-500 hover:bg-azure-600 text-white px-6 py-3 font-medium transition-all duration-300 rounded-l-full"
          >
            Let's Connect
          </motion.button>
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="group flex-1 bg-white/10 hover:bg-white/15 text-white/90 hover:text-white px-6 py-3 font-medium transition-all duration-300 rounded-r-full flex items-center justify-center space-x-2 border-l border-white/20"
          >
