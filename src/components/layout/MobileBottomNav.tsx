  ...
  return (
    <AnimatePresence>
      <motion.nav
        ...
        className="fixed left-1/2 -translate-x-1/2 bottom-[env(safe-area-inset-bottom)] z-50 md:hidden w-full max-w-[100vw] box-border overflow-x-hidden pt-2 pb-[env(safe-area-inset-bottom)]"
                    ...
                    return (
                      <li key={item.to} className="flex-1">
                        ...
                        >
                          ...
                          <div className="relative w-full h-14 min-h-[56px] flex items-center justify-center px-2">
